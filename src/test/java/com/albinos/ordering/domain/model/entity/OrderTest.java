...
import com.albinos.ordering.domain.model.exception.ProductOutOfStockException;
...
class OrderTest {
    ...
    public void shouldGenerateDraftOrder() {
        ...
        Assertions.assertWith(order,
                ...
                o -> Assertions.assertThat(o.shippin()).isNull(),
    ...
    public void givenDraftOrder_whenChangeShipping_shouldAllowChange() {
        ...
        Assertions.assertWith(order, o -> Assertions.assertThat(o.shippin()).isEqualTo(shipping));
    }
