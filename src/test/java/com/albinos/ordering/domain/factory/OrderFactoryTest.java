package com.albinos.ordering.domain.factory;

import com.albinos.ordering.domain.entity.Order;
import com.albinos.ordering.domain.entity.OrderTestDataBuilder;
import com.albinos.ordering.domain.entity.PaymentMethod;
import com.albinos.ordering.domain.entity.ProductTestDataBuilder;
...
class OrderFactoryTest {
    ...
    public void shouldGenerateFilledOrderThatCanBePlaced() {
        ...
        Assertions.assertWith(order,
                o-> Assertions.assertThat(o.shippin()).isEqualTo(shipping),
